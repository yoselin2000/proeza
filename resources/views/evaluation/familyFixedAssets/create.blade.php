<div class="modal fade text-dark" id="familyFixedAssetCreate">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('family_fixed_assets.store') }}" method="POST">
                {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control form-control-border" placeholder="Año/Compra" name="year" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name">Valor Actual</label>
                                    <input type="number" class="form-control form-control-border" placeholder="Valor Actual" name="amount" step="0.001" required>
                                </div>
                            </div>
                        </div>
                    </div>
