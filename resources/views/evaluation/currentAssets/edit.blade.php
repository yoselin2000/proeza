<div class="modal fade text-dark" id="currentAssetEdit{{ $currentAsset->id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('current_assets.update', $currentAsset->id) }}" method="POST">
                {{ csrf_field() }}
                {{ @method_field('PUT') }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="select2-primary">
                                        <select class="select2 form-control-border" data-placeholder="Select a State" data-dropdown-css-class="select2-primary" style="width: 100%;" name="asset_type_id" required>
                                            <option value="{{ $currentAsset->assetType->id }}">{{ $currentAsset->assetType->name }}</option>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control form-control-border" placeholder="Valor" name="amount" step="0.001" value="{{ $currentAsset->amount }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
