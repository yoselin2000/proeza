<div class="modal fade text-dark" id="evaluationAssetCreate">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('evaluation_assets.store') }}" method="POST">
                {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-border" placeholder="Descripcion/Ubicacion" name="description" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-border" placeholder="Registro, Placa, Otros" name="complement" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="name">Valor</label>
                                    <input type="number" class="form-control form-control-border" placeholder="Valor" name="value" step=".01" required>
                                </div>
                            </div>
                        </div>
                    </div>
