                                ...
                                <div class="form-group">
                                    ...
                                    <div class="select2-primary">
                                        <select class="select2 form-control-border" data-placeholder="Select a State" data-dropdown-css-class="select2-primary" style="width: 100%;" name="element_id" required>
                                            <option value="{{ $document->element->id }}">{{ $document->element->name }}<option>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-border" placeholder="Tipo de Documento" name="name" value="{{ $document->name }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
