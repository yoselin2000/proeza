<div class="modal fade text-dark" id="documentCreate">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-border" placeholder="Tipo de Documento" name="name" required>
                                </div>
                            </div>
                        </div>
                    </div>
