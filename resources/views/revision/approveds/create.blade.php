@isset($user)
<div class="modal fade text-dark" id="approvedCreate{{ $application->id }}">
@endisset
@isset($users)
<div class="modal fade text-dark" id="approvedCreate">
@endisset
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('approveds.store') }}" method="POST">
                {{ csrf_field() }}
