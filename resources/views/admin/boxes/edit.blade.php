<div class="modal fade text-dark" id="boxEdit{{ $box->id }}">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-border" placeholder="Nombre" name="name" value="{{ $box->name }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select form-control-border" name="agency_id" required>
                                        <option value="{{ $box->agency->id }}">{{ $box->agency->name }}</option>
