<div class="modal fade text-dark" id="destinationEdit{{ $destination->id }}">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-border" placeholder="Destino" name="name" value="{{ $destination->name }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
