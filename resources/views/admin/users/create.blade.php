<div class="modal fade text-dark" id="userCreate">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-border" placeholder="Correo" name="email" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-border" placeholder="Contraseña" name="password" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-border" placeholder="Confirma Contraseña" name="password_confirmation" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
