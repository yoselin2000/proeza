<div class="modal fade text-dark" id="roleCreate">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-border" placeholder="Cargo" name="post" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-border" placeholder="Acronimo" name="acronym" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
