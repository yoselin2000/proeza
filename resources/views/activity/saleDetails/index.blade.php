...
@section('title')
    <div class="row">
        <h1 class="m-0">Detalle de productos</h1>
                    ...
                    <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                            @foreach ($saleDetails as $saleDetail)
                                <tr>
                                    <td>{{ $saleDetail->activity->evaluation->participant->client->lastName }} {{ $saleDetail->activity->evaluation->participant->client->secondLastName }} {{ $saleDetail->activity->evaluation->participant->client->name }}  {{ $saleDetail->activity->evaluation->participant->client->thirdLastName }}</td>
                                    <td>{{ $saleDetail->inventory->name ?? '' }}</td>
