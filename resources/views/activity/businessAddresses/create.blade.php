<div class="modal fade text-dark" id="businessAddressCreate">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('business_addresses.store') }}" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                {{ csrf_field() }}
