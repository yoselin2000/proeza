<div class="modal fade text-dark" id="companyCreate">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-border" placeholder="Cargo que desempeña" name="post" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name">Antiguedad (años) </label>
                                    <input type="number" class="form-control form-control-border" placeholder="Antiguedad (años) " name="antiquity" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control form-control-border" placeholder="Liquido pagable" name="salary" step="0.001" required>
                                </div>
