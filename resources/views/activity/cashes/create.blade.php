<div class="modal fade text-dark" id="cashCreate">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control form-control-border" placeholder="Fecha de evaluacion" name="assessment" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="name">Fecha Ultima Compra</label>
                                    <input type="date" class="form-control form-control-border" placeholder="Fecha Ultima Compra" name="buys" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="name">Efectivo Real</label>
                                    <input type="number" class="form-control form-control-border" placeholder="Efectivo Real" name="real" step="0.001" required>
                                </div>
                            </div>
                        </div>
                    </div>
