<div class="modal fade text-dark" id="businessExpenseCreate">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('business_expenses.store') }}" method="POST">
                {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="select2-primary">
                                        <select class="select2 form-control-border" data-placeholder="Select a State" data-dropdown-css-class="select2-primary" style="width: 100%;" name="expense_type_id" required>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control form-control-border" placeholder="Valor" name="amount" step="0.001">
                                </div>
                            </div>
                        </div>
                    </div>
