<div class="modal fade text-dark" id="complementEdit{{ $complement->id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('complements.update', $complement->id) }}" method="POST">
                {{ csrf_field() }}
                {{ @method_field('PUT') }}
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select form-control-border" name="complement_type_id" required>
                                        <option value="{{ $complement->complementType->id }}">{{ $complement->complementType->name }}</option>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="my-textarea" class="form-control form-control-border" name="description" rows="3">{{ $complement->description }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
