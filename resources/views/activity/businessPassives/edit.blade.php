<div class="modal fade text-dark" id="businessPassiveEdit{{ $businessPassive->id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('business_passives.update', $businessPassive->id) }}" method="POST">
                {{ csrf_field() }}
                {{ @method_field('PUT') }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="select2-primary">
                                        <select class="select2 form-control-border" data-placeholder="Select a State" data-dropdown-css-class="select2-primary" style="width: 100%;" name="passive_type_id" required>
                                            <option value="{{ $businessPassive->passiveType->id }}">{{ $businessPassive->passiveType->name }}</option>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control form-control-border" placeholder="Monto" name="amount" step="0.001" value="{{ $businessPassive->amount }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="name">Cuota</label>
                                    <input type="number" class="form-control form-control-border" placeholder="Cuota" name="share" step="0.001" value="{{ $businessPassive->share }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="name">Plazo</label>
                                    <input type="number" class="form-control form-control-border" placeholder="Plazo" name="term" value="{{ $businessPassive->term }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select form-control-border" name="frecuency" required>
                                        <option>{{ $businessPassive->frecuency }}</option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select form-control-border" name="destination" required>
                                        <option>{{ $businessPassive->destination }}</option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select form-control-border" name="warranty" required>
                                        <option>{{ $businessPassive->warranty }}</option>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control form-control-border" placeholder="Saldo" name="balace" step="0.001" value="{{ $businessPassive->balace }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
