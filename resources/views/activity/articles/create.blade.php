<div class="modal fade text-dark" id="articleCreate">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-border" placeholder="Unidad de produccion" name="production" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
